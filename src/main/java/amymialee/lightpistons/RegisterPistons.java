...
import amymialee.lightpistons.blocks.LightMovingPistonBlock;
...
public class RegisterPistons {
    ...
    public static void onBlocksRegistration(final RegistryEvent.Register<Block> blockRegisterEvent) {
        ...
        lightMovingPiston = new LightMovingPistonBlock().setRegistryName("lightpistons", "light_moving_piston");
