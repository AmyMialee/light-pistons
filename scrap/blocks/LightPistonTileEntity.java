...
public class LightPistonTileEntity extends TileEntity implements ITickableTileEntity {
    ...
    public LightPistonTileEntity() {
        super(TileEntityType.PISTON);
    }

    public LightPistonTileEntity(BlockState pistonStateIn, Direction pistonFacingIn, boolean extendingIn, boolean shouldHeadBeRenderedIn) {
        this();
