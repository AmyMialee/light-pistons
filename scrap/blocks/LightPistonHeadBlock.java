...
public class LightPistonHeadBlock extends DirectionalBlock {
    ...
    public LightPistonHeadBlock() {
        ...
        this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(TYPE, PistonType.DEFAULT).with(SHORT, Boolean.FALSE));
    }
    ...
    private boolean isExtended(BlockState baseState, BlockState extendedState) {
        Block block = baseState.get(TYPE) == PistonType.DEFAULT ? RegisterPistons.lightPiston : RegisterPistons.lightStickyPiston;
        return extendedState.matchesBlock(block) && extendedState.get(LightPistonBlock.EXTENDED) && extendedState.get(FACING) == baseState.get(FACING);
    }
    ...
    public boolean isValidPosition(BlockState state, IWorldReader worldIn, BlockPos pos) {
        ...
        return this.isExtended(state, blockstate) || blockstate.matchesBlock(RegisterPistons.lightMovingPiston) && blockstate.get(FACING) == state.get(FACING);
    }
    ...
    public ItemStack getItem(IBlockReader worldIn, BlockPos pos, BlockState state) {
        return new ItemStack(state.get(TYPE) == PistonType.STICKY ? RegisterPistons.lightStickyPiston : RegisterPistons.lightPiston);
    }
