...
public class LightPistonBlockStructureHelper {
    ...
    public LightPistonBlockStructureHelper(World worldIn, BlockPos posIn, Direction pistonFacing, boolean extending) {
        this.world = worldIn;
    ...
    public boolean canMove() {
        ...
        if (LightPistonBlock.canPush(blockstate, this.world, this.blockToMove, this.moveDirection, false, this.facing)) {
    ...
    private boolean addBlockLine(BlockPos origin, Direction facingIn) {
        ...
        if (world.isAirBlock(origin)) {
            return true;
        } else if (LightPistonBlock.canPush(blockstate, this.world, origin, this.moveDirection, false, facingIn)) {
            return true;
            ...
            if (i + this.toMove.size() > 12) {
                ...
                while(blockstate.isStickyBlock()) {
                    ...
                    if (blockstate.isAir(this.world, blockpos) || !oldState.canStickTo(blockstate) ||
                            LightPistonBlock.canPush(blockstate, this.world, blockpos, this.moveDirection, false,
                                    this.moveDirection.getOpposite()) || blockpos.equals(this.pistonPos)) {
                        break;
                    }
                ...
                while(true) {
                    ...
                    if (LightPistonBlock.canPush(blockstate, this.world, blockpos1, this.moveDirection, true, this.moveDirection)
